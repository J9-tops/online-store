...
const CategoryCard = ({ category }: Props) => {
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 py-1 shadow-md overflow-hidden hover:shadow-lg transition-shadow w-full flex gap-3">
      <div className="p-1 border border-gray-500 rounded-sm w-fit">
